...
const getHappinessChange = (list: string[]) => {
	...
	const attendees = Object.keys(members)

	members.me = {}

	attendees.forEach((attendee) => {
		members.me[attendee] = 0
		members[attendee].me = 0
	})

	const options = permute(Object.keys(members), true)
...
const run = async () => {
	...
	console.log(`The answer for 13b is: ${happinessChange}`)
}
